package AoCStrangersChoiceOne2020
...
val fakeTestData: List<Int> = listOf(1, 5, 100)

fun main() {

    //Filtrerar ut tal som tillsammans innehåller 2020 via metoden Contains, den retunerar en Array med dem tal som tillsammans blir måltalet
    fun searchFor2020(goalNumber: Int) = intData.filter {focusNumber -> intData.contains(goalNumber - focusNumber)}

    //Tar in ett målvärde som inparameter, sedan filtrerar man via att ta subtrahera varje siffra i listan med "målsiffran" och sedan kolla vilka 2 tal som tillsammans summerar till det kvarstående talet i detta fall [615, 903, 502]
