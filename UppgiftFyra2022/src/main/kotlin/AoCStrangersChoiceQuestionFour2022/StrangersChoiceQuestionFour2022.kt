...
fun intList(input: List<String>): List <List<Int>> {
    return input.map {
...
fun Count1(input: List<String>): Int {
    return intList(input).count { (val1, val2, val3, val4) ->
        listOf(
...
fun Count2(input: List<String>): Int {
    return intList(input).count { (first, second, third, fourth) ->
        listOf(
...
fun main() {
    //Part 1 utskrift
    println(Count1(input))
    //Part 2 utskrift
    println(Count2(input))
}